...
class BinarySearchTreeTest {
    ...
    BinarySearchTree<Integer> instance;
    ...
    public void testSize() {
        ...
        BinarySearchTree<String> sInstance = new BinarySearchTree();
